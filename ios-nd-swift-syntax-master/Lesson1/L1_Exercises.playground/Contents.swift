...
let yourSentence = "My Rochelle swims in the \(nounArray[2])"
let yourSillySentence = "My \(nounArray[index1]) swims in the \(nounArray[index2])"
//: ### Exercise 2
...
let characterCount = howManyCharacters.characters.count
...
let stringWithNoLikes = lottaLikes.stringByReplacingOccurrencesOfString("like,", withString: "")
...
let numOfDollars = numOfPennies / 100
let numOfCents = numOfPennies % 500
let moneySaved = "$\(numOfDollars).\(numOfCents)"
print(moneySaved)
//: # Let or Var?
import UIKit
import Foundation
...
var stringToReverse = "Mutable or Immutable? That is the question." //TODO:Choose let or var
