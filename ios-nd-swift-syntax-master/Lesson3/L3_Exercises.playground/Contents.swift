...
//: 1b) Initialize an array of 5 bools using array literal syntax.
  ...
  let boolArray = [false, true, false, true, false]
...
admitted.append(waitingList[0])
admitted.append(waitingList[1])
//: ### Exercise 7
...
let food = ["Anchovies": false, "Coconut": true, "Cilantro": false, "Liver": true]
...
let oldEntry = presidentialPetsDict.removeValueForKey("George Bush")
presidentialPetsDict["George W. Bush"] = oldEntry
//: ### Exercise 11
...
if let dog = presidentialDogs["Barack Obama"] {
    ...
    print("Michelle doesn't walk any pets")
}
