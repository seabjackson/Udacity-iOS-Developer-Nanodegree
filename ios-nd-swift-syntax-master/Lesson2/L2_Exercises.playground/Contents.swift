...
if let director = director {
    print("Director \(director) directed the movie \(movie)")
}
...
if let artist = paintingDict[painting] {
    print("\(artist) is the artist who painted \(painting)")
}
...
if let parentViewController = childViewController.parentViewController {
    print("parentViewController found")
} else {
    print("parentViewController not found")
}
